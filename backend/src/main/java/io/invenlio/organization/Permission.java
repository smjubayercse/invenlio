...
public enum Permission {
 ORGANIZATION_READ("organization:read"),ORGANIZATION_UPDATE("organization:update"),MEMBER_READ("member:read"),MEMBER_INVITE("member:invite"),MEMBER_UPDATE("member:update"),MEMBER_REMOVE("member:remove"),ROLE_READ("role:read"),ROLE_CREATE("role:create"),ROLE_UPDATE("role:update"),ROLE_DELETE("role:delete"),ROLE_ASSIGN("role:assign"),AUDIT_READ("audit:read"),
 ...
 SHIPPING_READ("shipping:read"),SHIPPING_MANAGE("shipping:manage"),SHIPPING_DISPATCH("shipping:dispatch");
