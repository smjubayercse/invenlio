...
Lot/batch, serial and expiry traceability extend each ledger/balance stock dimension as documented in ADR-014. Reservations, availability, receiving, put-away, picking, transfer and shipping are deferred. PostgreSQL, not Redis or Kafka, is authoritative.
